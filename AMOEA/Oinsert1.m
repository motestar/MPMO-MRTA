...
function [ EP, EPval] = Oinsert1( ci,pop,popval, M,amount,robot_a,robot_b,num1,rs,dmat,vrobot,v1,fai ,kesai)
...
for ii = 1 : ci
    ...
    for i = 1 : popsize
        ...
        for j = 1 : wor_len
            ...
            [a,b] = oneseqval(tempworst_seq,amount,robot_a, robot_b,num1, dmat, vrobot,v1,fai,kesai); % 当前序列的两个目标值
            ...
            for k = 1 : (be_len+1)
                ...
                [a,b] = oneseqval(temseq,amount,robot_a, robot_b,num1, dmat, vrobot,v1,fai,kesai); % 当前序列的两个目标值
