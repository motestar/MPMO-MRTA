...
function [ pop,popval,EP,EPval] = Iexchange1(z,ci, pop,popval, M,amount,robot_a,robot_b,num1,rs,dmat,vrobot,v1,fai,kesai )
...
for ii = 1 : ci
    ...
    for i = 1 : pop_size
        ...
        fres = pop(i).fa;
        fits = fdis + ftime;
        dcur = ((fres(1) - z(1))^2 + (fres(2) - z(2))^2)^0.5;
            ...
            for k = 1 : ro_len           
                ...
                tempseq(pos) = t;             
                templist{j} = tempseq;
                [a,b] = oneseqval(tempseq,amount,robot_a, robot_b,num1, dmat, vrobot,v1,fai,kesai); % 当前序列的两个目标值
